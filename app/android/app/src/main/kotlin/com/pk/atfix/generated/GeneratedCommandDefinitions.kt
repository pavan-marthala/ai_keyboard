...
package com.pk.atfix.generated

data class GeneratedCommandDefinition(
    val id: String,
    val command: String,
    val label: String,
...
object GeneratedCommandDefinitions {
    val commands: List<GeneratedCommandDefinition> = listOf(
