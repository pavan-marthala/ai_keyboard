...
import com.pk.atfix.MainActivity
import com.pk.atfix.ai.AiFailure
import com.pk.atfix.ai.AiResult
import com.pk.atfix.clipboard.ClipboardHistoryManager
import com.pk.atfix.command.CommandParser
import com.pk.atfix.command.NativeCommandRegistry
import com.pk.atfix.gif.*
import com.pk.atfix.suggestion.AospSuggestionEngine
...
import com.pk.atfix.transform.AiTextTransformer
import com.pk.atfix.voice.VoiceImeHelper
import com.pk.atfix.voice.VoiceImeSwitcher
import com.pk.atfix.voice.VoiceInputController
import com.pk.atfix.voice.VoiceState
...
class KeyboardController(
    ...
    private val suggestionEngine: SuggestionEngine = com.pk.atfix.suggestion.aosp.AospSuggestionAdapter(context),
    ...
    fun updateGeometry(widthPx: Int, heightPx: Int, useNumbers: Boolean) {
        if (suggestionEngine is com.pk.atfix.suggestion.aosp.AospSuggestionAdapter) {
