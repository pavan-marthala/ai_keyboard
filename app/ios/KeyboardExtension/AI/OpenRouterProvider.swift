...
class OpenRouterProvider: AiProvider {
    ...
    func transform(
        ...
        let endpoint = (baseURL?.isEmpty == false) ? baseURL! : "https://openrouter.ai/api/v1/chat/completions"
        ...
        request.setValue("AI Keyboard iOS", forHTTPHeaderField: "HTTP-Referer")
