...
class OpenAiProvider: AiProvider {
    ...
    func transform(
        ...
        let endpoint = (baseURL?.isEmpty == false) ? baseURL! : "https://api.openai.com/v1/chat/completions"
        ...
        let systemInstruction = "You are a text transformation engine inside a keyboard. Transform the text according to instructions. Return ONLY the transformed text. Do not explain, add notes, or use surrounding quotes."
